...
func (mc *MessageCreate) SetAuthor(m message.Author) *MessageCreate {
	mc.mutation.SetAuthor(m)
	return mc
}
...
func (mc *MessageCreate) check() error {
	...
	if _, ok := mc.mutation.Author(); !ok {
		return &ValidationError{Name: "author", err: errors.New(`ent: missing required field "Message.author"`)}
	}
	if v, ok := mc.mutation.Author(); ok {
